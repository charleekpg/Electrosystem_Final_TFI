Public Class BE_Presupuesto
    ...
    Private _dibujotecnico As BE_DibujoTecnico
    Public Property dibujotecnico() As BE_DibujoTecnico
        Get
            Return _dibujotecnico
        End Get
        Set(ByVal value As BE_DibujoTecnico)
            _dibujotecnico = value
        End Set
    End Property
