        ...
        Try
            ...
            For Each fila As DataRow In datatable.Rows
                ...
                Else
                    ...
                    tmp_domicilio.localidad.latitud = fila(19)
                    tmp_domicilio.localidad.longitud = fila(20)
                    ...
                    If seguridad.descifrar(unbe.estado_presupuesto) = "Pendiente de llenado por parte del Responsable Comercial" Then
                        tmppresupuesto.porcentaje_caneriaycableado = fila(21)
                        tmppresupuesto.porcentaje_llaveytoma = fila(22)
                        tmppresupuesto.porcentaje_losa = fila(23)
                        tmppresupuesto.porcentaje_tablero = fila(24)
                        tmppresupuesto.porcentaje_terminacion = fila(25)
                        tmppresupuesto.departamento_granescala = fila(26)
                        tmppresupuesto.Instalacion_compleja = fila(27)
                    End If
                    If seguridad.descifrar(unbe.estado_presupuesto) = "Cerrado" Then
                        ...
                        tmppresupuesto.departamento_granescala = fila(26)
                        tmppresupuesto.Instalacion_compleja = fila(27)
                        tmppresupuesto.masde400bocas = fila(28)
                        tmppresupuesto.masde20km = fila(29)
                        tmppresupuesto.valor_manodeobra = fila(30)
                        tmppresupuesto.valor_seguro_vida = fila(31)
                        tmppresupuesto.valor_otros = fila(32)
                        tmppresupuesto.actualizaicac = fila(33)
                        tmppresupuesto.valor_material = fila(34)
                        tmppresupuesto.valor_trabajoconprecio = fila(35)
                        tmppresupuesto.porcentaje_aldarluz = fila(36)
                        tmppresupuesto.valor_total = fila(37)
                    End If
